...
const CardBarChart = ({ 
  ...
  return (
      <div className={`${lightThemes[themeColor as keyof typeof CardBarChart]} rounded-lg p-6 relative w-full break-words mb-5 hover:ring`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className={`w-14 h-10 rounded-full flex items-center justify-center ${solidThemes[themeColor as keyof typeof CardBarChart]} text-white`}>
